...
class ThoughtBoxTests(unittest.TestCase):
    ...
    def test_listThoughtsByTags(self):
        ...
        self.assertEqual(d_comp['first'], [ 
                         ('1', 'first') ])

        self.assertEqual(d_comp['second'], [ 
                         ('2', 'second') ])

        self.assertEqual(d_comp['cat'], [ 
                         ('1', 'first'),
                         ('4', 'forth')])

        self.assertEqual(d_comp['dog'], [ 
                         ('2', 'second'),
                         ('3', 'third')])

        self.assertEqual(d_comp['mouse'], [ 
                         ('3', 'third'),
                         ('4', 'forth')])
    ...
    def test_rename(self):
        ...
        self.tb.rename(Name.fromStr('2'), Name.fromStr('5'))
...
class ThoughtBox_PersistenceTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.first = self._addThought(tb,
            name="1", title="first", tags=["first", "cat"], links=["2", "3"]
        )

        self.second = self._addThought(tb,
            name="2", title="second", tags=["second", "dog"], links=["4"]
        )

        self.third = self._addThought(tb,
            name="3", title="third", tags=["dog", "mouse"], links=["4"]
        )

        self.forth = self._addThought(tb,
            name="4", title="forth", tags=["cat", "mouse"], links=["1", "3"]
        )
